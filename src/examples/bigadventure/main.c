...
const char *garden_descs[100] = {
    ...
    "A BED OF WILD TULIPS IN PINK AND LILAC BOWING",
    "A BED OF WILD MARIGOLDS BOWING HEADS IN THE EVENING",
    "A BED OF WILD COMFREY RUFFLED AND BRIGHT BY THE GATE",
    "A BED OF WILD POPPY BOWING HEADS IN THE EVENING",
    "A BED OF WILD BORAGE BLOOMING BLUE IN THE DAWN",
    "A BED OF WILD CARNATION BOWING HEADS IN THE BREEZE",
    "A BED OF WILD COLUMBINE DROOPING GOLDEN BLOOMS IN SHADE",
    "A BED OF WILD DELPHINIUM TOWERING BLUE IN THE SUN",
    "A BED OF WILD SNAPDRAGON FLAMING RED IN THE DAWN",
    "A BED OF WILD NASTURTIUM SPREADING BRIGHT BY THE WALL",
    "A BED OF WILD HONEYSUCKLE TWISTING OVER THE STONE GATE",
    "A BED OF WILD CORNFLOWER SCATTERED BLUE IN THE FIELD",
    "A BED OF WILD PANSY BLOOMING PURPLE IN THE MORNING SUN",
    "A BED OF WILD BELLFLOWER BOWING HEADS IN THE WIND",
    "A BED OF WILD ZINNIA BLOOMING BRIGHT IN THE EVENING",
    "A BED OF WILD FOXGLOVE TOWERING PURPLE IN THE DAWN",
    "A BED OF WILD GERANIUM BLOOMING ROSE IN THE SUN",
    "A BED OF WILD BALLOON FLOWER BOWING HEADS IN THE BREEZE",
};
...
const char *castle_descs[100] = {
	...
	"DAMP STONE CELLAR BENEATH THE KITCHEN",
	"NARROW ARROW LOOP IN THE CURTAIN WALL",
	"WORN OAK DOOR TO THE SCULLION'S RANGE",
	"SPIRAL STAIR WITH A SINGLE OCULUS WINDOW",
	"BLACKENED IRON GRATE OVER THE GREAT HEARTH",
	"MOSSY FLAGSTONE FLOOR OF THE INNER COURTYARD",
	"RUSTED IRON RINGS ON THE PORTCULLIS",
	"COLD DRAFT CLIMBING THE ROUND TOWER",
	"LOUVERED SHUTTERS ON THE KING'S CHAMBER",
	"CRACKED CEILING TILES ABOVE THE GUARD ROOM",
	"STONE WELL HEAD WITH A CREAKING WINDLASS",
	"SMOKE-STAINED BEAM ACROSS THE GREAT HALL",
	"NARROW PASSAGE BETWEEN THE TWIN WALLS",
	"IRON-BARRED WINDOW IN THE EASTERN CELL",
	"SHALLOW POOL OF WATER IN THE UNDERCROFT",
	"WOODEN GALLERY OVERLOOKING THE ENTRANCE",
	"GRANITE BLOCKS OF THE OUTER FOUNDATION",
	"BROKEN CRENELLATION ALONG THE BATTLEMENTS",
	"FADED MURAL ON THE CHAPEL WALL",
	"PEELING PAINT ON THE MINSTREL'S RAILING",
	"COLD STONE SEAT BY THE INNER STAIR",
	"RUSTED CHAIN IN THE DRAINAGE PIT",
	"MUDDY FLOOR OF THE STABLE BLOCK",
	"CROOKED BEAM SUPPORTING THE HAY LOFT",
	"IRON HOOKS ALONG THE ARMORY WALL",
	"SLANTED ROOF WHERE THE TILES ARE MISSING",
	"DAMP CORNER OF THE PRISON CORRIDOR",
	"CHIPPED MARBLE STEPS IN THE CHAPEL",
	"WOODEN SHELF ABOVE THE WRITING DESK",
	"CRACKED WINDOW LOOKING OUT OVER THE MOAT",
	"STONE ARCH ABOVE THE SALLY PORT",
	"MOSS GROWING BETWEEN THE FLOOR TILES",
	"HEAVY OAK DOOR TO THE OUTER GATE",
	"DUST-THICK SHELF IN THE LIBRARY ANTECHAMBER",
	"IRON GRATE OVER THE DRAINAGE CHANNEL",
	"WORN STONE THRESHOLD AT THE ENTRANCE",
	"CRACKED FLAGSTONE IN THE INNER COURTYARD",
	"RUSTED IRON NAIL IN THE WOODEN PANELING",
	"MOLD ON THE BACK WALL OF THE STORAGE ROOM",
	"STONE BENCH BESIDE THE INNER WELL",
	"BROKEN HINGE ON THE KITCHEN DOOR",
	"GRAFFITI SCRATCHED INTO THE DUNGEON WALL",
	"WOODEN BARREL LEANING AGAINST THE STONE WALL",
	"SLIVER OF LIGHT THROUGH THE CHAPEL WINDOW",
	"STONE SLAB MARKING THE OLD BOUNDARY",
	"RUST-STAINED IRON ON THE COUNTERWEIGHT PIT",
	"CROOKED WOODEN POST IN THE GUARD ROOM",
	"COLD DRAFT FROM THE ARROW SLIT",
	"STONE BASIN HOLDING ONLY DUST AND LEAF LITTER",
	"WOODEN LADDER PROPPED AGAINST THE INNER WALL",
	"PEELING PLASTER ON THE TOWER INTERIOR",
};
...
const char *village_descs[100] = {
    ...
    "A WILD GARDEN GATE WHERE IVY CLIMBS THE RUSTED HINGE",
    ...
    "A STONY ROSE BUSH WHERE THORNS CATCH THE MORNING DAWN",
    "A WET LILY POND WHERE FROGS SIT ON SPLIT BARK",
    "A DRY HERB GARDEN WHERE THYME AND MINT STILL CURL",
    "A COLD APPLE ORCHARD WHERE WORMS STILL EAT THE CORE",
    "A WARM SUNFLOWER FIELD WHERE STALKS STILL BOW TO THE WEST",
    "A NOISY BEETLE GARDEN WHERE WINGS STILL BUMP THE PETAL",
    "A DUSTY TOMBOWEED PATCH WHERE SEEDS STILL SPLIT THE DIRT",
    "A COLD WISTERIA ARCH WHERE PETALS STILL DRIP ON THE STONE",
    "A WORN PEONY BED WHERE STALKS STILL BEND TO THE WIND",
    "A HOT MARIGOLD PATCH WHERE PETALS STILL CURL IN THE SUN",
    "A DRY CLOVER GARDEN WHERE BLOOMS STILL DOT THE DIRT",
    "A COLD DAISY PATCH WHERE PETALS STILL WHITER THAN THE STONE",
    "A WORN HEDGEHOG GARDEN WHERE BRISTLES STILL CATCH THE MIST",
    "A NOISY BUTTERFLY GARDEN WHERE WINGS STILL DRIFT ON THE BREEZE",
    "A DRY MOSS GARDEN WHERE GREEN STILL CLINGS TO THE STONE"
};
...
const char *riverside_descs[100] = {
	...
	"A WEATHERED STONE COTTAGE PERCHED ON THE MUDDY BANK OF A WINDING RIVER, WITH LAUNDRY HANGING FROM A WOODEN FENCE",
	"AN ANCIENT WILLOW TREE LEANING OVER THE RIVERBANK ITS ROOTS HALF-SUBMERGED IN THE FLOWING CURRENT",
	"A RUSTED FISHING PIER JUTTING OUT INTO THE MIDDLE OF THE RIVER WITH PEELING PAINT ON ITS SUPPORTS",
	"ABANDONED BOAT STORAGE SHED SITTING ON THE GRAVELLY SHORE WITH A COLLAPSED TIN ROOF",
	"A NARROW STRIP OF LAND WHERE THE RIVER MEETS A MARSHY WETLAND FILLED WITH REEDS AND CATTAILS",
	"OLD CONCRETE STEPS LEADING DOWN TO THE WATER'S EDGE NOW COVERED IN MOSS AND SEDIMENT",
	"A CRUMBLING RIVER WALL BUILT OF ROUGH-HEWN GRANITE BLOCKS THAT ONCE HELD BACK THE RISING WATER",
	"MANGROVE ROOTS TWISTING TOGETHER ALONG THE RIVERBANK FORMING A TANGLED UNDERWATER FOREST",
	"ABANDONED RIVER DOCK WITH BENT IRON MOORING CLEATS STILL CLINGING TO A FADED WOODEN PLATFORM",
	"STONY RIVERBAR EXPOSED ONLY AT LOW TIDE WHERE THE WATER RECEDES INTO SILTY CHANNELS",
	"TATTERED GREEN NET HANGING BETWEEN TWO TREES AT THE RIVER'S EDGE WHERE FISHERS ONCE WAITED",
	"SMALL SANDBAR ISLAND DOTTED WITH REEDS AND DUCK NESTING IN THE MIDDLE OF THE RIVER",
	"A LEANING TELEPHONE POLE STANDING IN THE SHALLOW PART OF THE RIVER WITH FRAYING WIRES ABOVE",
	"WEATHERED WOODEN PADDLEBOAT MOORED TO A RUSTED ANCHOR HALF-SWAMPED IN THE SHALLOWS",
	"MUDFLATS STRETCHING ALONG THE RIVER'S BEND WHERE HERONS STALK AND MUDSKIPPERS BOUNCE",
	"CONCRETE SPILLWAY WHERE THE RIVER TUMBLES OVER AN OLD DAM INTO A WHITE FROTHING POOL",
	"TANGLE OF DRIFTWOOD AND BRANCHES STACKED AGAINST THE FAR BANK WHERE THE CURRENT SLOWS",
	"SMALL WOODEN FOOTBRIDGE CROSSING THE NARROW STRETCH OF RIVER WITH A ROTTING DECK PLANK IN THE CENTER",
	"OLD STONE LOCK GATE STANDING PARTIALLY OPEN WITH WEEDY GRASS GROWING THROUGH ITS HINGES",
	"RIVERBANK LINED WITH SMOOTH FLAT ROCKS WORN BY YEARS OF CONSTANT WATER FLOW",
	"TORN ORANGE LIFE VEST HANGING FROM A POST AT THE EDGE OF A POPULAR RIVER SWIMMING SPOT",
	"SHALLOW GRAVELLY STRETCH OF RIVER WHERE THE WATER RUNS CLEAR AND SHALLOW ENOUGH TO WADE THROUGH",
	"ABANDONED RIVERBOAT WITH A CRACKED HULL RESTING ON THE SANDBAR AT THE RIVER'S EDGE",
	"MOSS-COVERED ROCK IN THE MIDDLE OF THE RIVER SPLITTING THE CURRENT INTO TWO WHITE-EDGED STREAMS",
	"OLD CONCRETE FOOTBRIDGE SPANNING THE RIVER ITS RAILING GONE AND DECK SPLIT IN SEVERAL PLACES",
	"WILLOW TREES LEANING SO FAR OVER THE RIVER THEIR BRANCHES BRUSH THE WATER AND STIR THE SURFACE",
	"NARROW SANDY SPIT ON THE OUTER BANK OF THE RIVER WHERE THE WATER LAPS GENTLY AT LOW TIDE",
	"RUSTED STEEL BARGE FLOATING HALF-SUNK IN THE SHALLOWS WITH ITS DECK CAKED IN SILT",
	"TANGLED ROOT SYSTEM OF AN OLD OAK GRIPPING THE RIVERBANK WHERE THE CURRENT PULLS AT THE SOIL",
	"OLD STONE STEPPING-STONES HALF-SUBMERGED IN THE SHALLOW RIVER WITH ALGAE GROWING BETWEEN THEM",
	"CONCRETE ABUTMENT OF A LONG-GONE BRIDGE STANDING ALONE IN THE MIDDLE OF THE WIDENING RIVER",
	"REED BEDS STRETCHING ALONG THE SLOW-MOVING BEND OF THE RIVER THEIR TIPS SWAYING IN THE CURRENT",
	"WEATHERED WOODEN SIGNPOST POINTING TO A FOOTPATH BESIDE THE RIVER ITS LETTERS WORN AWAY",
	"SHALLOW ROCKY SECTION OF THE RIVER WHERE THE WATER FOAMS WHITE OVER SUBMERGED STONES",
	"OLD ROPE-AND-POST MOORING SYSTEM ALONG THE RIVERBANK WHERE LOCAL FERRIES ONCE TIED UP",
	"MUD-COVERED TIRE HALF-BURIED IN THE SILT AT THE RIVER'S EDGE A FORGOTTEN RELIC OF PAST FLOODING",
	"BENT WOODEN STAKE DRIVEN INTO THE RIVER MUD MARKING A FORMER FERRY CROSSING POINT",
	"GRASSY EMBANKMENT WHERE THE RIVER HAS ERODED THE BANK LEAVING AN OVERHANG OF HANGING SOIL",
	"SMALL CONCRETE CHANNEL CUTTING THROUGH THE RIVER SAND WHERE THE CURRENT FUNNELED INTO AN OLD IRRIGATION SYSTEM",
	"TANGLED MASS OF BRANCHES AND LIMBS PILED HIGH ON THE RIVERBANK AFTER THE LAST SPRING FLOOD",
	"OLD GRANITE MARKER STONE AT THE RIVER'S EDGE WORN SMOOTH AND ILLEGIBLE BY WATER AND TIME",
	"RUST-COLORED MUDBANK WHERE THE RIVER WIDENS AND THE CURRENT DROPS LEAVING SILT IN ITS WAKE",
	"BROKEN CONCRETE WEIR SPANNING PART OF THE RIVER WITH WHITE WATER CASCADING OVER ITS CRACKED SURFACE",
	"SHALLOW SANDBAR IN THE MIDDLE OF THE RIVER SHIFTING SHAPE WITH EVERY SEASON'S FLOOD",
	"TATTERED FISHING LINE STILL CAUGHT IN A SUBMERGED TREE BRANCH ALONG THE RIVER'S ROCKY SHORE",
	"OLD WOODEN BUCKET SUSPENDED FROM A CROOKED POLE AT THE RIVERBANK WHERE SOMEONE ONCE DREW WATER",
	"GRAVELLY RIVERBANK STREWN WITH SMOOTH PEBBLES AND HALF-BURIED GLASS BOTTLES FROM DECADES PAST",
	"BEND IN THE RIVER WHERE THE OUTER BANK HAS COLLAPSED LEAVING A TANGLE OF EXPOSED TREE ROOTS",
	"OLD STONE PIER EXTENDING INTO THE RIVER ITS EDGE CHIPPED AND BROKEN FROM YEARS OF BOAT TRAFFIC",
	"SHALLOW POOL BEHIND A ROCK WHERE THE RIVER SLOWS AND THE WATER TAKES ON A GREENISH TINT",
	"TORN TARPAULIN DRAPED OVER A PILE OF OLD LUMBER BESIDE THE RIVER ITS EDGES FLAPPING IN THE WIND",
	"MUDFLAT WHERE THE RIVER MEETS A BACKWATER POOL AND THE WATER STANDS STILL AND STILL",
};
